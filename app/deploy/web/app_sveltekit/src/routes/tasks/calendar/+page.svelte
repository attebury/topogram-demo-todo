<script lang="ts">
  ...
  {
    "id": "sample-active",
    "title": "Task Calendar sample",
    "message": "Task Calendar sample",
    "description": "Generated from Topogram UI contract metadata.",
    "status": "active"
  },
  {
    "id": "sample-completed",
    "title": "Task Calendar completed sample",
    "message": "Task Calendar completed sample",
...
<main>
  <div class="stack">
    <section class="card">
      ...
      <h1>Task Calendar</h1>
      <p>This SvelteKit page was generated from <code>task_calendar</code>.</p>
    </section>
