...
assert.equal(todo.defaultVersion, "0.1.9");
...
assert.match(humanList.stdout, /todo@0\.1\.9/);
...
assert.equal(showPayload.packageSpec, "@attebury/topogram-template-todo@0.1.9");
assert.equal(
