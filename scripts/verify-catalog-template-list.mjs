...
assert.equal(todo.defaultVersion, "0.1.29");
...
assert.match(humanList.stdout, /todo@0\.1\.29/);
...
assert.equal(showPayload.packageSpec, "@attebury/topogram-template-todo@0.1.29");
assert.equal(
