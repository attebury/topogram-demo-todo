...
assert.equal(payload.project.catalog.packageSpec, "@attebury/topogram-template-todo@0.1.10");
...
assert.equal(payload.project.template.sourceSpec, "@attebury/topogram-template-todo@0.1.10");
assert.equal(payload.project.package.package, "@attebury/topogram-template-todo");
assert.equal(payload.project.package.packageSpec, "@attebury/topogram-template-todo@0.1.10");
if (mode === "remote") {
  assert.equal(payload.project.package.currentVersion, "0.1.10");
